...
class TestDnacHealthscoreWorkflow(TestDnacModule):
    ...
    test_data = loadPlaybookData("healthscore_settings_workflow_manager")
    ...
    def load_fixtures(self, response=None, device=""):
        ...
        # if "error_while_update" in self._testMethodName:
        #     self.run_dnac_exec.side_effect = [
        #         self.test_data.get("require_update_kpi_detail"),
        #         Exception()
        #         # self.test_data.get("healthscore_settings_updation"),
    ...
    # def test_healthscore_settings_workflow_manager_no_updation(self):
    #     """
